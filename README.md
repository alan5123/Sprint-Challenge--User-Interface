...
It is a way to organie your html, so its easier to read for other devs also nesscesary for css.
...
so you can all work on the same project at the same time. also save your code along the way with notes.
